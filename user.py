#sudo -s
#sudo python user.py --add streamer_lsl --num 0
...
#class yapsy.Pligin<anager.PluginManager(categories_filter=None,directories_list=None,plugin_info_ext=None,plugin_locator=None)
if __name__ == '__main__':
    ...
    parser.add_argument('-n', '--num',
                        help="The number for recording file")
    ...
    parser.set_defaults(daisy=True, log=False)#default not daisy mode
    ...
    #_init_:setPluginPlaces for directories_list
    manager.collectPlugins()
    #walk through the plugins' places and look for plugins.
    # then for each plugin candidate look for its category,load it and stores it in the appropriate slot of the category_mapping.
    ...
    if args.info:
        ...
        if plugin == None:
            ...
            print (plugin.description)#description?
    ...
    if board.daisy: #force daisy mode
